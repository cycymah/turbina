  ...
  return (
    <main className="main">
        <section className = "main__container-text">
            ...
            <ul className ="main__list">
                <li className="main__text"><p className ="main__description">— Дети никогда не прекращают творить и круто стараться быть на них похожими в этом</p></li>
                <li className="main__text"><p className ="main__description">— Детское бессознательное помогает родителям понять, что происходит внутри семьи</p></li>
                <li className="main__text"><p className ="main__description">— Не существует детской и взрослой поэзии. Существует мысль и чувство, зафиксированное в ней</p></li>
                <li className="main__text"><p className ="main__description">— Дети получают невероятное удовольствие и мотивацию от того, что их творчество востребовано сверстниками и взрослыми.</p></li>
            </ul>
        </section>
    </main>
  );
