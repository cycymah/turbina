  ...
  return (
    <>
      <form action="#" name="user-form" className="form" onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <input type="checkbox" className="form__confirm-button" id="form-checkbox" ></input>
        <label htmlFor="form-checkbox" className="form__label"> Согласен с&nbsp;
          <span>
            <a className="form__link" target="_blank" rel="noreferrer" href="#">офертой</a>
          </span>
        </label> 
